...
$HDFS_BIN/bin/hdfs dfs -copyToLocal $rawfile_file $local_work_folder
...
$HDFS_BIN/bin/hdfs dfs -mkdir -p $hdfs_work_folder/$hdfs_csv_folder/$wfid/
$HDFS_BIN/bin/hdfs dfs -mkdir -p $hdfs_work_folder/$hdfs_fix_folder/$wfid/
$HDFS_BIN/bin/hdfs dfs -mkdir -p $hdfs_work_folder/$hdfs_ses_folder/$wfid/
