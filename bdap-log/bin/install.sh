...
#make lib
$java_home/bin/jar -uf ../lib/bdap.log-r0.5.0.jar -C ../cfg etlengine.properties -C ../cfg log4j.properties -C ../cfg log4j2.xml

hdfs dfs -rm -r ${bdap_dir}/log/

#copy lib
hdfs dfs -mkdir -p ${bdap_dir}/log/lib
hdfs dfs -copyFromLocal -f ../lib/bdap.log-r0.5.0.jar ${bdap_dir}/log/lib/
