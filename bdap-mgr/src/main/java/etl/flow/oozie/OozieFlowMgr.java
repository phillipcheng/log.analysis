...
public class OozieFlowMgr extends FlowMgr{
	...
	/*
	oozie.libpath=${nameNode}/user/${user.name}/bdap-r0.5.0/lib/
	oozie.wf.application.path=${nameNode}/user/${user.name}/pde-r0.5.0/binfile/binfile_workflow.xml
	note: ${nameNode}/user/${user.name}/pde-r0.5.0/binfile/lib/ not needed in oozie.libpath, as can be implied from oozie.wf.application.path
	 */
	...
	/*
	oozie.libpath=${nameNode}/user/${user.name}/bdap-r0.5.0/lib/,${nameNode}/user/${user.name}/pde-r0.5.0/binfile/lib/
	oozie.coord.application.path=${nameNode}/user/${user.name}/pde-r0.5.0/binfile/binfile_coordinator.xml
	workflowAppUri=${nameNode}/user/${user.name}/pde-r0.5.0/binfile/binfile_workflow.xml
	flowName=test1
	duration=15
